...
prior_sample_df = pd.read_csv('Data/order_products_prior_sample.csv')
...
train_sample_df = pd.read_csv('Data/order_products_train_sample.csv')
...
orders_prior_sample_df = pd.read_csv('Data/orders_prior_sample.csv')
print("\nFirst five rows of orders_prior_sample.csv:\n",
      orders_prior_sample_df.head(), sep="\n")
print("\nDimensions of orders_prior_sample.csv:\n",
      orders_prior_sample_df.shape, sep="\n")
print("\nNull values in orders_prior_sample.csv:\n",
      (orders_prior_sample_df.isnull()).sum(), sep="\n")

orders_train_sample_df = pd.read_csv('Data/orders_train_sample.csv')
print("\nFirst five rows of orders_train_sample.csv:\n",
      orders_train_sample_df.head(), sep="\n")
print("\nDimensions of orders_train_sample.csv:\n",
      orders_train_sample_df.shape, sep="\n")
print("\nNull values in orders_train_sample.csv:\n",
      (orders_train_sample_df.isnull()).sum(), sep="\n")
